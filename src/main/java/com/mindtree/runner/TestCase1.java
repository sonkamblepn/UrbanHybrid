...
public class TestCase1 extends BaseClass{
	...
	public void test8() throws InterruptedException {
		...
		Assert.assertTrue(chair.getStudyChair().equals("Study Chairs"),"Not Found");;
		logger.pass("click on study chair");
	}
	...
	public void test9() throws InterruptedException {
		...
		logger.info("Starting Test to check whether click on Mirror");
		MenuPage menu=new MenuPage(driver);
		menu.clickOnDecor();
		menu.clickOnMirror();
		logger.pass("Click on Mirror successfully");
		driver.navigate().back();
	} 
